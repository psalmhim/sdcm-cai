function DCM = spm_dcm_calcium_csd_data(DCM)
% Get cross-spectral density data-features using a VAR model
% FORMAT DCM = spm_dcm_calcium_csd_data(DCM)
% DCM    -  DCM structure or calcium
%
% sets
%
...
% same as spm_dcm_fmri_csd_data 
% Karl Friston
% Modified from SPM12 (https://www.fil.ion.ucl.ac.uk/spm/)
...
% DCM.M.N   = 32;
% DCM.M.ns  = 1/DCM.Y.dt;
% DCM.Y.csd = spm_csd_calcium_mtf(pP,DCM.M,DCM.U);
% 
