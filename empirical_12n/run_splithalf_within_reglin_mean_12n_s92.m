...
% Server-92 batch: subjects 13,15,17 only (paired with _s89.m running the other 4
% subjects on server 89, to halve wall-clock time). Once both finish and their
...
fprintf('\n=== Split-half within-subject (12n RegLin-Mean), server-92 subset ===\n');
...
fprintf('Done with server-92 subset. Per-half .mat files saved to %s\n', data_dir);
