function run_sc_binary_12n(subj_id)
maxNumCompThreads(1);
...
DCM.name=sprintf('DCM_sc_binary_12n_s%d', subj_id);

fprintf('S%d sc-binary 12n... ', subj_id); rng(0); t0=tic;
DCM_est = spm_dcm_calcium_csd(DCM);
out = fullfile(data_dir, sprintf('subject_%d_DCM_sc_binary_12n.mat', subj_id));
