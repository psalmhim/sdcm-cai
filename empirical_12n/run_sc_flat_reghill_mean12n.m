function run_sc_flat_reghill_mean12n(subj_id)
% M1-flat, regional Hill obs, 12-node MEAN signal (no z-transform).
...
DCM.name=sprintf('DCM_sc_flat_reghill_mean12n_s%d', subj_id);

fprintf('S%d sc-flat RegHill mean12n... ', subj_id); rng(0); t0=tic;
DCM_est = spm_dcm_calcium_csd(DCM);
out = fullfile(data_dir, sprintf('subject_%d_DCM_sc_flat_reghill_mean12n.mat', subj_id));
