%% run_sensitivity_s16_alpha_b050.m
% Prior mean perturbation, alpha=0.50, N_mc=10.
% Run on server 89 in parallel with run_sensitivity_s16_alpha_b025.m.
% rng seeds: 4001-4010 (ai_global=4, consistent with alpha_a ai=1,2).
...
data_dir = './zebra/';
out_mat  = fullfile(data_dir,'sensitivity_12n_s16_alpha_b050.mat');

n  = 12; N_mc = 10; alp = 0.50; ai_global = 4;
TR = 0.5;
