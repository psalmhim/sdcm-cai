...
for si = 1:numel(subjects)
    s = subjects(si);
    fprintf('\n=== Subject %d (server 89, proper iter2) ===\n', s);
    try
...
fprintf('\n=== Split-half iter2 (PROPER reinversion), server-89 subset ===\n');
...
save(fullfile(data_dir,'splithalf_within_iter2proper_s89_results.mat'), ...
    'r_flat','r_iter2','subjects','failed','-v7.3');
fprintf('Saved splithalf_within_iter2proper_s89_results.mat\nDone.\n');
